...
@Configuration
public class RecieverTypeCofiguration {
	...
	/*
	 * @Bean public Binding buildConnection(Queue queueName,DirectExchange
	 * exchangeName) { return
	 * BindingBuilder.bind(queueName).to(exchangeName).with(routingKey); }
	 */
